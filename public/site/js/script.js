...
(function ($) { "use strict";
    ...
    $(".gallery .thumb .frame").tooltip({
        'placement': 'top'
    });

    $(".standard.gallery .item").tooltip({
        'placement': 'top'
    });

    $(".person .socials a").tooltip({
        'placement': 'top'
    });

    $(".parteners.carousel img").tooltip({
        'placement': 'top'
    });

    $(".parteners.boxes .item").tooltip({
        'placement': 'top'
    });

    $(".blog-wrapper .single .post-accordion .post-thumb").tooltip({
        'placement': 'bottom'
    });

    $(".advertising .element .inside").tooltip({
        'placement': 'bottom'
    });
    });
