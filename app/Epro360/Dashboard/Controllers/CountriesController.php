...
class CountriesController extends \BaseController {
	...
	public function index()
	{
		...
		return View::make('dashboard.locations.countries.index',compact('countries'));
	}
	...
	public function create()
	{
        ...
        return View::make('dashboard.locations.countries.create', compact('continents'));
    }
	...
	public function edit($id)
	{
		...
		return View::make('dashboard.locations.countries.edit', compact('continents', 'country'));
	}
