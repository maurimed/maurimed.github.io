...
<!--                    <li><img src="/admin/img/avatars/1.png" alt="friend-1">-->
<!--                    </li>-->
<!--                    <li><img src="/admin/img/avatars/2.png" alt="friend-2">-->
<!--                    </li>-->
<!--                    <li><img src="/admin/img/avatars/3.png" alt="friend-3">-->
<!--                    </li>-->
<!--                    <li><img src="/admin/img/avatars/4.png" alt="friend-4">-->
<!--                    </li>-->
<!--                    <li><img src="/admin/img/avatars/5.png" alt="friend-5">-->
<!--                    </li>-->
<!--                    <li><img src="/admin/img/avatars/male.png" alt="friend-6">-->
<!--                    </li>-->
<!--                    <li>-->
...
<!--                <ul class="list-inline friends-list">-->
<!--                    <li><img src="/admin/img/avatars/male.png" alt="friend-1">-->
<!--                    </li>-->
<!--                    <li><img src="/admin/img/avatars/female.png" alt="friend-2">-->
<!--                    </li>-->
<!--                    <li><img src="/admin/img/avatars/female.png" alt="friend-3">-->
<!--                    </li>-->
<!--                </ul>-->
<!--            </div>-->
        </div>
