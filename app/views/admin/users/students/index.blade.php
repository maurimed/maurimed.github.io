...
@section('ribbon')
@include('admin.layouts.partials.ribbon', ['breadcrumbs' => ['Users','Students', 'List']])
@stop

@section('title')
@include('admin.layouts.partials.page-title',['title' => 'Students', 'subtitle' => '> List', 'icon' => 'user'])
@stop
...
<div class="jarviswidget jarviswidget-color-darken" id="wid-id-103" data-widget-editbutton="false">
