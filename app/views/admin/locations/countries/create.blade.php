...
@section('ribbon')
@include('admin.layouts.partials.ribbon', ['breadcrumbs' => ['Locations','Countries', 'Create']])
@stop

@section('title')
@include('admin.layouts.partials.page-title',['title' => 'Countries', 'subtitle' => '> Create', 'icon' => 'map-marker'])
@stop
