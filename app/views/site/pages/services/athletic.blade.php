...
@section('content')
	@include('site.layouts.partials.components.breadcums', ['title' => Lang::get('menu.services.athletic_scholarships')])
        ...
        <div class="row">
            <div class="col-md-3 main-el">
                <div class="side-menu" id="side-menu-1">
                    ...
                    {{ link_to_route('services.athletic', Lang::get('menu.services.athletic_scholarships'),[], ['class' => 'element active']) }}
            ...
            <div style="text-align: justify"  class="col-md-9 main-el">
                <h3>{{ Lang::get('services.athletic_scholarships.title') }}</h3>

                <h4>{{ Lang::get('services.athletic_scholarships.subtitle1') }}</h4>
                <p>{{ Lang::get('services.athletic_scholarships.p1') }} </p>

                <div class="dividing sep-line"></div>

                <h4>{{ Lang::get('services.athletic_scholarships.subtitle2') }}</h4>

				<p class="bold"> <i class="fa fa-check-square-o"></i>{{ Lang::get('services.athletic_scholarships.li1') }} </p>
				<p class="bold"> <i class="fa fa-check-square-o"></i>{{ Lang::get('services.athletic_scholarships.li2') }} </p>
				<p class="bold"> <i class="fa fa-check-square-o"></i>{{ Lang::get('services.athletic_scholarships.li3') }} </p>

				<p class="small"><cite>{{ Lang::get('services.athletic_scholarships.note1') }}</cite></p>

                <div class="dividing sep-line"></div>

                <h4>{{ Lang::get('services.athletic_scholarships.subtitle3') }}</h4>
                <p>{{ Lang::get('services.athletic_scholarships.p3') }} </p>

				<p class="small"><cite>{{ Lang::get('services.athletic_scholarships.note2') }}</cite></p>
