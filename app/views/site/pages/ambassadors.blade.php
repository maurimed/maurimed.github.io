...
@include('site.layouts.partials.components.breadcums', ['title' => 'Ambassadors from ' . $ambassadors->name])
...
<!--                    {{ $ambassadors->ambassadors }}-->
                    @if($ambassadors->ambassadors->count())
                    @foreach($ambassadors->ambassadors as $ambassador)
...
<!--                                    </div>-->
<!--                                </div>-->
                                <img src="/site/img/ambassadors/{{ $ambassador->profile->image }}" alt="{{ $ambassador->firstname . ' ' .$ambassador->firstname }}" class="img-responsive">
                            </div>
                            <div class="details">
                                <h5 class="medium name">{{ $ambassador->firstname . ' ' .$ambassador->lastname }}</h5>
                                <p class="italic title"> <i class="fa fa-flag"></i> {{ $ambassadors->name }} </p>
