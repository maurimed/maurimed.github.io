...
@section('ribbon')
    @include('dashboard.layouts.partials.ribbon', ['breadcrumbs' => [$ambassador->userable_type, $ambassador->username, 'Profile']])
@stop

@section('title')
    @include('dashboard.layouts.partials.page-title',['title' => $ambassador->userable_type, 'subtitle' => '> ' . $ambassador->username, 'icon' => 'user'])
@stop
...
//        var $registerForm = $("#ambassador-form-edit").validate({
//
