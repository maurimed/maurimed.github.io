...
@section('ribbon')
@include('dashboard.layouts.partials.ribbon', ['breadcrumbs' => ['Institutions','Universities', 'Create']])
@stop

@section('title')
@include('dashboard.layouts.partials.page-title',['title' => 'Universities', 'subtitle' => '> Create', 'icon' => 'institution'])
@stop
...
<section id="widget-grid" class="">
    ...
    <div class="row">
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
            ...
            <div class="jarviswidget jarviswidget-color-darken" id="wid-id-81" data-widget-editbutton="false"  data-widget-deletebutton="false">
