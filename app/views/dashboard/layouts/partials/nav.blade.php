...
@if( $currentUser->hasAccess('Director') )
<li>
    ...
    <ul>
        <li class="{{ setActive('ambassadors') }}" >
            {{ link_to_route('dashboard.directors.ambassadors.index', 'Ambassadors', [ $currentUser->userable->id ]) }}
        </li>
        <li class="{{ setActive('students') }}" >
            {{ link_to_route('dashboard.directors.students.index', 'Students',  [ $currentUser->userable->id ]) }}
        </li>
    </ul>
</li>
@endif
...
@endif
@if( $currentUser->hasAccess('Student') )

    <li class="{{ setActive('requirements') }}">
        <a href="/dashboard/students/{{ $currentUser->userable->id }}/requirements " title="Requirements"><i class="fa fa-lg fa-fw fa-file-text-o"></i> <span  class="menu-item-parent">Requirements</span></a>
    </li>
@endif
