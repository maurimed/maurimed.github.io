...
<html lang="en-us">
	<head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="/backend/css/custom.css">
	...
	<body class="minified">
		...
		@include('dashboard.layouts.partials.left-panel')
		<!-- END NAVIGATION -->
		...
		<div id="main" role="main">
            ...
            @include('sessions.messages')
				...
				<div class="row">
					...
					<!-- col -->
                    <!--@include('dashboard.layouts.partials.graphs')-->
					<!-- end col -->
		...
		-->
		@include('dashboard.layouts.partials.shortcut-area')
		<!-- END SHORTCUT AREA -->
		...
		<script>
			if (!window.jQuery) {
				document.write('<script src="/backend/js/libs/jquery-2.0.2.min.js"><\/script>');
			}
		</script>
