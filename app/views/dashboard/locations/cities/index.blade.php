...
@section('ribbon')
@include('dashboard.layouts.partials.ribbon', ['breadcrumbs' => ['Locations','Cities', 'List']])
@stop

@section('title')
@include('dashboard.layouts.partials.page-title',['title' => 'Cities', 'subtitle' => '> List', 'icon' => 'map-marker'])
@stop
...
<div class="jarviswidget jarviswidget-color-darken" id="wid-id-30" data-widget-editbutton="false"  data-widget-deletebutton="false">
<!-- widget options:
