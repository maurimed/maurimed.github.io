...
@section('ribbon')
@include('dashboard.layouts.partials.ribbon', ['breadcrumbs' => ['Locations','Cities', 'Create']])
@stop

@section('title')
@include('dashboard.layouts.partials.page-title',['title' => 'Cities', 'subtitle' => '> Create', 'icon' => 'map-marker'])
@stop
...
<script src="/backend/jsjs/plugin/jquery-form/jquery-form.min.js"></script>
