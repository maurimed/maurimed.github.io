...
return array(
    ...
    "message_from_co_founders" => [
        ...
        "p2" => "Our Coaches and Mentors are not just simple advisors, they are important role models with track records of academic and professional excellence. They are living proof that a well-balanced, global education prepares students for life not to mention success. Epro 360 is far more than a placement service for a US college education. This is needed, especially in this world of academic inflation, which many university students experience nowadays. <em>Academic inflation is a term that describes the decreasing value of a college degree over time, because more people receive one.</em> ",
        ...
        "p5" => "Epro 360 is known as a network that provides individual attention, coaching and mentoring to each and every student: All while finding the best financial deal for a US education. Our many Epro 360 Leaders (Coaches and Leaders) provide a network of support that lasts a lifetime.",
